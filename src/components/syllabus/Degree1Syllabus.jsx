...
import {
  DEGREE_1_MODULES,
  DEGREE_1_SPECIALIZATION_OPTIONS,
  calculateDegree1Metrics
} from '../../data/degree1SyllabusData';
import './DegreeSyllabus.css';

const LOCAL_STORAGE_KEY = 'syllabus_degree1_progress';

const Degree1Syllabus = () => {
  ...
  const [savedProgress, setSavedProgress] = useState(() => {
    try {
      ...
      console.error('Failed to parse Degree 1st Year syllabus progress from localStorage:', e);
      return {};
    }
  });
  ...
  const statusSummary = useMemo(() => {
    ...
    const currentModule = todayClass ? todayClass.moduleTitle : 'Video Editing & Motion';
  ...
  const filteredModules = useMemo(() => {
    return DEGREE_1_MODULES.map((mod) => {
  ...
  return (
    <div className="degree-syllabus-container">
      ...
      <div className="syllabus-header-card">
        <h1 className="main-dashboard-title">Degree 1st Year Digital Skills Syllabus</h1>
        <p className="main-dashboard-subtitle">
          Foundational to Intermediate Digital & Creative Engineering
        </p>
        <p className="main-dashboard-subtext">
          Comprehensive practical curriculum based on undergraduate student survey interests: Video Editing (CapCut/Premiere Pro), Photoshop & Canva Graphic Design, AI Tools & Prompt Engineering, Web Development (HTML/CSS/JS/Python), and Digital Workplace Touch Typing.
        </p>

        <div className="header-metadata-chips">
          <span className="meta-chip"><i className="fas fa-bullseye"></i> Goal: Skill Development & Job Readiness</span>
          <span className="meta-chip"><i className="fas fa-layer-group"></i> 5 Modules</span>
          <span className="meta-chip"><i className="fas fa-book-reader"></i> 25 Practical Classes</span>
          <span className="meta-chip"><i className="fas fa-chart-line"></i> Framework: Learn → Practice → Create</span>
        </div>
      </div>
              ...
              >
                ...
                <div className="mod-card-body">
                  <h4 className="mod-title">
                    <i className={mod.icon || 'fas fa-book'}></i> {mod.title}
                  </h4>
                ...
                <div className="module-block-header">
                  <div>
                    ...
                    <h2 className="mod-block-title">
                      <i className={mod.icon || 'fas fa-folder'}></i> {mod.title}
                    </h2>
      ...
      <div className="final-specialization-card">
        <div className="spec-header-block">
          ...
          <h2>Degree 1st Year Capstone Options</h2>
          <p>Select your final term specialization portfolio deliverable:</p>
        </div>

        <div className="spec-options-grid">
          {DEGREE_1_SPECIALIZATION_OPTIONS.map((track) => (
            <div className="spec-option-card" key={track.id}>
              ...
              <p style={{ fontSize: '0.82rem', fontWeight: 700, color: '#2563EB', marginTop: '6px' }}>
                Portfolio: {track.portfolioDeliverable}
              </p>
            </div>
          ))}
        </div>
...
export default Degree1Syllabus;
