...
import {
  ...
  calculateDegree3Metrics
} from '../../data/degree3SyllabusData';
import './DegreeSyllabus.css';

const LOCAL_STORAGE_KEY = 'syllabus_degree3_progress';

const Degree3Syllabus = () => {
  ...
  const [savedProgress, setSavedProgress] = useState(() => {
    try {
      ...
      console.error('Failed to parse Degree 3rd Year syllabus progress from localStorage:', e);
      return {};
    }
  });
  ...
  const statusSummary = useMemo(() => {
    ...
    const currentModule = todayClass ? todayClass.moduleTitle : 'AI Engineering & Career Mastery';
  ...
  const filteredModules = useMemo(() => {
    return DEGREE_3_MODULES.map((mod) => {
  ...
  return (
    <div className="degree-syllabus-container">
      ...
      <div className="syllabus-header-card">
        <h1 className="main-dashboard-title">Degree 3rd Year Digital Skills Syllabus</h1>
        <p className="main-dashboard-subtitle">
          Advanced Industry Engineering, AI Architecture & Career Mastery
        </p>
        <p className="main-dashboard-subtext">
          Mastery-level digital skills curriculum engineered directly from final-year undergraduate survey demands: Advanced AI Prompting & AI Agents (Claude 3.5/n8n), Master Excel Data Analytics (XLOOKUP/Pivot Dashboards), Cybersecurity & Web Engineering, High-End Enterprise Photoshop/Illustrator Media, and Freelancing (Upwork/Fiverr) & E-Commerce (Amazon) Career Launch.
        </p>

        <div className="header-metadata-chips">
          <span className="meta-chip"><i className="fas fa-brain"></i> Mastery: AI Engineering & Career Acceleration</span>
          <span className="meta-chip"><i className="fas fa-layer-group"></i> 5 Industry Modules</span>
          <span className="meta-chip"><i className="fas fa-book-reader"></i> 25 Master Classes</span>
          <span className="meta-chip"><i className="fas fa-briefcase"></i> Career Focus: Freelancing, Amazon & Jobs</span>
        </div>
      </div>
      ...
      <div className="filter-controls-bar">
        <div className="search-box-wrapper">
          ...
          <input
            ...
            placeholder="Search AI Agents, Excel Dashboards, Cybersecurity, Amazon, Freelancing..."
            value={searchQuery}
                ...
                {mod.realProject && (
                  <div className="real-project-card">
                    <div className="rp-badge">
                      <i className="fas fa-award"></i> MODULE REAL PROJECT
                    </div>
      ...
      <div className="final-specialization-card">
        <div className="spec-header-block">
          ...
          <h2>Degree 3rd Year Graduation Specializations</h2>
          <p>Select your final degree graduation career deliverable track:</p>
        </div>

        <div className="spec-options-grid">
          {DEGREE_3_SPECIALIZATION_OPTIONS.map((track) => (
...
export default Degree3Syllabus;
