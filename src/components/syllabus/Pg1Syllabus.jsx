...
import {
  PG_1_MODULES,
  PG_1_SPECIALIZATION_OPTIONS,
  calculatePg1Metrics
} from '../../data/pg1SyllabusData';
import './DegreeSyllabus.css';

const LOCAL_STORAGE_KEY = 'syllabus_pg1_progress';
...
const Pg1Syllabus = () => {
  ...
  const [savedProgress, setSavedProgress] = useState(() => {
    try {
      ...
      console.error('Failed to parse PG 1st Year syllabus progress from localStorage:', e);
      return {};
    }
  });
  ...
  const statusSummary = useMemo(() => {
    ...
    const currentModule = todayClass ? todayClass.moduleTitle : 'Advanced Office & Typing';
  ...
  return (
    <div className="degree-syllabus-container">
      ...
      <div className="syllabus-header-card">
        <h1 className="main-dashboard-title">PG 1st Year Digital Skills Syllabus</h1>
        <p className="main-dashboard-subtitle">
          Postgraduate Advanced Digital Productivity & Web Engineering Program
        </p>
        <p className="main-dashboard-subtext">
          Comprehensive practical curriculum tailored from postgraduate survey demands: Advanced MS Office (Word/Excel/PowerPoint), Arabic & Malayalam Touch Typing, Photoshop & Canva Graphic Design, Video Editing (CapCut/Premiere Pro), Applied AI Research Tools, and Web Development (HTML/CSS/JS).
        </p>

        <div className="header-metadata-chips">
          <span className="meta-chip"><i className="fas fa-graduation-cap"></i> Masters Level 1</span>
          ...
          <span className="meta-chip"><i className="fas fa-laptop-code"></i> AI & Web Engineering</span>
        </div>
      </div>
      ...
      <div className="filter-controls-bar">
        <div className="search-box-wrapper">
          ...
          <input
            ...
            placeholder="Search Word, Excel, Photoshop, AI, HTML/CSS..."
            value={searchQuery}
      ...
      <div className="final-specialization-card">
        <div className="spec-header-block">
          ...
          <h2>PG 1st Year Specialization Options</h2>
          <p>Select your master's program term deliverable track:</p>
        </div>

        <div className="spec-options-grid">
          {PG_1_SPECIALIZATION_OPTIONS.map((track) => (
